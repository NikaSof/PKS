...
//                           icon: Icon(
//                             Icons.favorite,
//                             color: widget.card[index].favorites ? Colors.red : Colors.grey,
//                           ),
//                           onPressed: () {
//                             setState(() {
...
//                             // onPressed: () {
//                             //   setState(() {
//                             //     toggleFavorite(widget.card[index]);
//                             //   });
//                             // },
//                           },
//                         ),
...
//             },
//           ),
//           // Загрузка или кнопка перезагрузки
              ...
              children: [
                ...
                Positioned(
                        ...
                        child: SizedBox(
                          ...
                          child: Align(
                            alignment: Alignment.center,
                            child: carts.any((cartItem) => cartItem.items.id == widget.products[index].id)
                                ? const Icon(Icons.check)
                                : IconButton(
                              icon: const Icon(Icons.add),
                              onPressed: () {
                                setState(() {
                                  carts.add(CartItem(widget.products[index], 1));
                                });
                              },
                            ),
                          ),
